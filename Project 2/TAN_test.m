...
% Load images
match1 = imbinarize(imread('tan_test.gif'));
match3 = imbinarize(imread('tan_test_rotated.gif'));
...
for i = 1:num_objects_match1
    ...
    fprintf('Object %d in match1 best matches Object %d in match3 with distance %.2f\n', i, best_matches(i), distance_matrix(i, best_matches(i)));
end